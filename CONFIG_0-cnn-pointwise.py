...
#If trainingModel, should an existing database in the RESULTS folder be loaded instad of creating a new one
...
measurementPercs = np.arange(2,41).tolist()
