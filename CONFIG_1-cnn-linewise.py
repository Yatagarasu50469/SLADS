...
partialLineMethod = True

#Should lines be allowed to be revisited
lineRevistMethod = False

#Should only the top stopPerc of points be considered in each line; all lines scanned at least once
percLineMethod = True

#Should only points equal or greater than the threshold (ERD image mean) be scanned
theshLineMethod = False
...
#Which system GPU(s) are available; (None, chooses whichever is avaialble)
availableGPUs = None
