...
def simulateSampling(sortedSampleFolders, dir_Results, optimalC, modelName):
    ...
    if not bypassSampling:
        ...
        sampleDataset = [SampleData(sampleFolder, initialPercToScan, stopPerc, scanMethod, lineRevist, True, False, False, False, liveOutputFlag, False, False, oracleTesting) for sampleFolder in tqdm(sortedSampleFolders, desc='Imports', leave=True, ascii=asciiFlag)]
    ...
    for index in tqdm(range(0, len(resultLocations)), desc='Processing', position=0, leave=True, ascii=asciiFlag):
        ...
        #Check if all channel data was evaluated as configured
        if allChanEval and not sampleData.allChanEvalFlag: print('\nWarning - All channel evaluation was enabled but not available/considered for sample: ', sampleData.name)
        ...
        if sampleData.allChanEvalFlag: allAvgPSNR_Results.append(result.allAvgPSNRList)
        ...
        if sampleData.allChanEvalFlag: allAvgSSIM_Results.append(result.allAvgSSIMList)
        ...
        if sampleData.allChanEvalFlag: allAvgNRMSE_Results.append(result.allAvgNRMSEList)
        ...
        if sampleData.allChanEvalFlag: np.savetxt(result.dir_sampleResults+'PSNR_allAvg.csv', np.transpose([result.percsMeasured, result.allAvgPSNRList]), delimiter=',')
        ...
        if sampleData.allChanEvalFlag: np.savetxt(result.dir_sampleResults+'SSIM_allAvg.csv', np.transpose([result.percsMeasured, result.allAvgSSIMList]), delimiter=',')
        ...
        if sampleData.allChanEvalFlag: np.savetxt(result.dir_sampleResults+'NRMSE_allAvg.csv', np.transpose([result.percsMeasured, result.allAvgNRMSEList]), delimiter=',')
        ...
        if sampleData.allChanEvalFlag: basicPlot(result.percsMeasured, result.allAvgPSNRList, result.dir_sampleResults+'PSNR_allAvg'+'.tiff', xLabel='% Measured', yLabel='Average PSNR')
        ...
        if sampleData.allChanEvalFlag: basicPlot(result.percsMeasured, result.allAvgSSIMList, result.dir_sampleResults+'SSIM_allAvg'+'.tiff', xLabel='% Measured', yLabel='Average SSIM')
        ...
        if sampleData.allChanEvalFlag: basicPlot(result.percsMeasured, result.allAvgNRMSEList, result.dir_sampleResults+'NRMSE_allAvg'+'.tiff', xLabel='% Measured', yLabel='Average NRMSE')
    ...
    if not benchmarkNoProcessing:
        ...
        if sampleData.allChanEvalFlag: quantityMeasured, allAvgPSNR_Results_mean = percResults(allAvgPSNR_Results, quantityMeasured_Results, precision)
        ...
        if sampleData.allChanEvalFlag: quantityMeasured, allAvgSSIM_Results_mean = percResults(allAvgSSIM_Results, quantityMeasured_Results, precision)
        ...
        if sampleData.allChanEvalFlag: quantityMeasured, allAvgNRMSE_Results_mean = percResults(allAvgNRMSE_Results, quantityMeasured_Results, precision)
        ...
        if sampleData.allChanEvalFlag: allAvgPSNR_AUC = np.trapz(allAvgPSNR_Results_mean, quantityMeasured)
        if erdModel != 'GLANDS': 
        ...
        if sampleData.allChanEvalFlag: allAvgSSIM_AUC = np.trapz(allAvgSSIM_Results_mean, quantityMeasured)
        if erdModel != 'GLANDS': 
        ...
        if sampleData.allChanEvalFlag: allAvgNRMSE_AUC = np.trapz(allAvgNRMSE_Results_mean, quantityMeasured)
        if erdModel != 'GLANDS': 
        ...
        if sampleData.allChanEvalFlag: np.savetxt(dir_Results+'PSNR_allAvg.csv', np.transpose([quantityMeasured, allAvgPSNR_Results_mean]), delimiter=',')
        ...
        if sampleData.allChanEvalFlag: np.savetxt(dir_Results+'SSIM_allAvg.csv', np.transpose([quantityMeasured, allAvgSSIM_Results_mean]), delimiter=',')
        ...
        if sampleData.allChanEvalFlag: np.savetxt(dir_Results+'NRMSE_allAvg.csv', np.transpose([quantityMeasured, allAvgNRMSE_Results_mean]), delimiter=',')
        ...
        if sampleData.allChanEvalFlag: basicPlot(quantityMeasured, allAvgPSNR_Results_mean, dir_Results+'PSNR_allAvg'+'.tiff', xLabel='% Measured', yLabel='Average PSNR')
        ...
        if sampleData.allChanEvalFlag: basicPlot(quantityMeasured, allAvgSSIM_Results_mean, dir_Results+'SSIM_allAvg'+'.tiff', xLabel='% Measured', yLabel='Average SSIM')
        ...
        if sampleData.allChanEvalFlag: basicPlot(quantityMeasured, allAvgNRMSE_Results_mean, dir_Results+'NRMSE_allAvg'+'.tiff', xLabel='% Measured', yLabel='Average NRMSE')
        ...
        if sampleData.allChanEvalFlag: lastAllAvgPSNR = [allAvgPSNR_Results[i][-1] for i in range(0, numJobs)]
        ...
        if sampleData.allChanEvalFlag: lastAllAvgSSIM = [allAvgSSIM_Results[i][-1] for i in range(0, numJobs)]
        ...
        if sampleData.allChanEvalFlag: lastAllAvgNRMSE = [allAvgNRMSE_Results[i][-1] for i in range(0, numJobs)]
    ...
    if not benchmarkNoProcessing:
        ...
        #==========================================================================================================================================================================
        if sampleData.allChanEvalFlag: dataPrintout.append(['All Channel PSNR:', np.mean(lastAllAvgPSNR), '+/-', np.std(lastAllAvgPSNR)])
        if sampleData.allChanEvalFlag: dataPrintout.append(['All Channel PSNR AUC:', allAvgPSNR_AUC])
        ...
        if erdModel != 'GLANDS': 
            ...
            dataPrintout.append(['Avg ERD PSNR AUC:', avgERD_PSNR_AUC])
            dataPrintout.append(['Final Avg Chan ERD PSNR:', np.mean(lastAvgChanERD_PSNR), '+/-', np.std(lastAvgChanERD_PSNR)])
            dataPrintout.append(['Avg Chan ERD PSNR AUC:', avgChanERD_PSNR_AUC])
        dataPrintout.append([])
        
        if sampleData.allChanEvalFlag: dataPrintout.append(['All Channel SSIM:', np.mean(lastAllAvgSSIM), '+/-', np.std(lastAllAvgSSIM)])
        if sampleData.allChanEvalFlag: dataPrintout.append(['All Channel SSIM AUC:', allAvgSSIM_AUC])
        ...
        if erdModel != 'GLANDS': 
            ...
            dataPrintout.append(['Avg ERD SSIM AUC:', avgERD_SSIM_AUC])
            dataPrintout.append(['Final Avg Chan ERD SSIM:', np.mean(lastAvgChanERD_SSIM), '+/-', np.std(lastAvgChanERD_SSIM)])
            dataPrintout.append(['Avg Chan ERD SSIM AUC:', avgChanERD_SSIM_AUC])
        dataPrintout.append([])
        
        if sampleData.allChanEvalFlag: dataPrintout.append(['All Channel NRMSE:', np.mean(lastAllAvgNRMSE), '+/-', np.std(lastAllAvgNRMSE)])
        if sampleData.allChanEvalFlag: dataPrintout.append(['All Channel NRMSE AUC:', allAvgNRMSE_AUC])
    ...
    if sampleData.allChanEvalFlag and warningOOM: print('\nWarning - Fallback was used during full-spectra reconstructions; insufficient RAM was available for simultaneous operations on all workers.')
