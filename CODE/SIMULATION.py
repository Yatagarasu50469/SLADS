...
def simulateSampling(sortedSampleFolders, dir_Results, optimalC, modelName):
    ...
    for result in tqdm(results, desc='Visualization', position=0, leave=True, ascii=asciiFlag):
        ...
        allAvgPSNR_Results.append(result.allAvgPSNRList)
        ...
        allAvgSSIM_Results.append(result.allAvgSSIMList)
        ...
        np.savetxt(result.dir_sampleResults+'PSNR_allAvg.csv', np.transpose([result.percsMeasured, result.allAvgPSNRList]), delimiter=',')
        ...
        np.savetxt(result.dir_sampleResults+'SSIM_allAvg.csv', np.transpose([result.percsMeasured, result.allAvgSSIMList]), delimiter=',')
        ...
        basicPlot(result.percsMeasured, result.allAvgPSNRList, result.dir_sampleResults+'PSNR_allAvg'+'.png', xLabel=xLabel, yLabel='Average PSNR (dB)')
        ...
        basicPlot(result.percsMeasured, result.allAvgSSIMList, result.dir_sampleResults+'SSIM_allAvg'+'.png', xLabel=xLabel, yLabel='Average SSIM')
    ...
    quantityMeasured, allAvgPSNR_Results_mean = percResults(allAvgPSNR_Results, quantityMeasured_Results, precision)
    ...
    quantityMeasured, allAvgSSIM_Results_mean = percResults(allAvgSSIM_Results, quantityMeasured_Results, precision)
    ...
    allAvgPSNR_AreaUnderCurve = np.trapz(allAvgPSNR_Results_mean, quantityMeasured)
    chanAvgSSIM_AreaUnderCurve = np.trapz(chanAvgSSIM_Results_mean, quantityMeasured)
    allAvgSSIM_AreaUnderCurve = np.trapz(allAvgSSIM_Results_mean, quantityMeasured)
    ...
    np.savetxt(dir_Results+'PSNR_allAvg.csv', np.transpose([quantityMeasured, allAvgPSNR_Results_mean]), delimiter=',')
    ...
    np.savetxt(dir_Results+'SSIM_allAvg.csv', np.transpose([quantityMeasured, allAvgSSIM_Results_mean]), delimiter=',')
    ...
    basicPlot(quantityMeasured, allAvgPSNR_Results_mean, dir_Results+'PSNR_allAvg'+'.png', xLabel=xLabel, yLabel='Average PSNR (dB)')
    ...
    basicPlot(quantityMeasured, allAvgSSIM_Results_mean, dir_Results+'SSIM_allAvg'+'.png', xLabel=xLabel, yLabel='Average SSIM')
    ...
    dataPrintout.append(['All PSNR:', np.mean(lastAllAvgPSNR), '+/-', np.std(lastAllAvgPSNR)])
    dataPrintout.append(['All PSNR Area Under Curve:', allAvgPSNR_AreaUnderCurve])
    ...
    dataPrintout.append([])
    dataPrintout.append(['All SSIM:', np.mean(lastAllAvgSSIM), '+/-', np.std(lastAllAvgSSIM)])
    dataPrintout.append(['All SSIM Area Under Curve:', allAvgSSIM_AreaUnderCurve])
