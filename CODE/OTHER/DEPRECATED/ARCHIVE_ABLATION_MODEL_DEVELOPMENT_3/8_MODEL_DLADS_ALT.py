...
class Conv_CB_DLADS(nn.Module):
    def __init__(self, numIn, numOut, non_linearity, gateSkips):
        ...
        self.gate3 = Conv_SC_DLADS(numOut+numOut, numOut, 1, 'same', non_linearity)
    ...
    def forward(self, data):
        data1 = self.conv0(data)
        return self.gate3(torch.cat([data1, self.conv2(self.conv1(data1))], 1))
