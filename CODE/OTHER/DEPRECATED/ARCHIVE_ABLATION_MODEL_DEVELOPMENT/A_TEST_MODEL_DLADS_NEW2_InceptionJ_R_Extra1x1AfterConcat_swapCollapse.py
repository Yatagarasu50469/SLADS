...
class Conv_PC_DLADS(nn.Module):
    def __init__(self, numIn, numOut, non_linearity):
        ...
        self.gateO = Conv_SC_DLADS(numIn+numOut*4, numIn+numOut*4, 1, 'same', non_linearity)
        self.gateE = Conv_SC_DLADS(numIn+numOut*4, numOut, 1, 'same', non_linearity)
    ...
    def forward(self, data0):
        ...
        gateO = self.gateO(torch.cat([data0, gateI, data1, gate1, data2], 1))
        return self.gateE(gateO)
