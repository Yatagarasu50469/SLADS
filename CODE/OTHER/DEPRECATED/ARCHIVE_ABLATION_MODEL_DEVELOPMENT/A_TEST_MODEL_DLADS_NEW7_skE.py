...
class Conv_UP_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.convSk = Conv_SC_DLADS(numIn, numOut//2, 1, 'same', upAct)
        self.convDt = Conv_SC_DLADS(numIn, numOut//2, 1, 'same', upAct)
    ...
    def forward(self, data, skip):
        ...
        return self.conv1(torch.cat([self.convDt(data), self.convSk(skip)], 1))
