...
class Conv_PC_DLADS(nn.Module):
    def __init__(self, numIn, numOut, non_linearity):
        ...
        self.conv1 = Conv_SC_DLADS(numIn, numOut, 3, 'same', non_linearity)
        self.conv2 = Conv_SC_DLADS(numOut, numOut, 3, 'same', non_linearity)
        #self.conv3 = Conv_SC_DLADS(numOut, numOut, 3, 'same', non_linearity)
        self.gate1 = Conv_SC_DLADS(numOut*3, numOut, 1, 'same', non_linearity)
    ...
    def forward(self, data0):
        ...
        return self.gate1(torch.cat([gate0, data1, data2], 1))
