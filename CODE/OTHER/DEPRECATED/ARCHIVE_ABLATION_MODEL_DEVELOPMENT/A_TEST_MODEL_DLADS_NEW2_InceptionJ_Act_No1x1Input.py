...
class Conv_IN_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.conv1 = Conv_SC_DLADS(numIn, numOut, 3, 'same', inAct)
        self.gate1 = Conv_SC_DLADS(numOut, numOut, 1, 'same', inAct)
        self.conv2 = Conv_SC_DLADS(numOut, numOut, 3, 'same', inAct)
        self.gateO = Conv_SC_DLADS(numIn+numOut*3, numOut, 1, 'same', inAct)
