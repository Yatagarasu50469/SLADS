...
#Dimension reduction convolutional block for DLADS; no activation
class Conv_DR_DLADS_NA(nn.Module):
...
class Conv_UP_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        super().__init__()
        self.conv0 = Conv_DR_DLADS_NA(numIn, numOut)
        self.blur = Conv_BF_DLADS(numOut, stride=1)
