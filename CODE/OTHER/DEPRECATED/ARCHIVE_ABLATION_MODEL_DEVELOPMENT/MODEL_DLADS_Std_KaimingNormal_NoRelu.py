...
class Conv_PC_DLADS(nn.Module):
    def __init__(self, numIn, numOut, act):
        ...
        nn.init.kaiming_normal_(self.conv0.weight, a=negSlope, nonlinearity=nonlinearity)
        nn.init.kaiming_normal_(self.conv1.weight, a=negSlope, nonlinearity=nonlinearity)
...
class Conv_UP_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        nn.init.kaiming_normal_(self.conv0.weight, a=0.0, nonlinearity='relu')
...
class Model_DLADS(nn.Module):
    def __init__(self, numFilt, numChan):
        ...
        nn.init.kaiming_normal_(self.convFn0.weight, a=0.0, nonlinearity='relu')
