...
class Conv_PC_DLADS(nn.Module):
    def __init__(self, numIn, numOut, act):
        ...
        nn.init.xavier_normal_(self.conv0.weight, gain=gain)
...
class Conv_UP_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        nn.init.xavier_normal_(self.conv0.weight, gain=nn.init.calculate_gain('relu'))
...
class Model_DLADS(nn.Module):
    def __init__(self, numFilt, numChan):
        ...
        nn.init.xavier_normal_(self.convFn0.weight, gain=nn.init.calculate_gain('relu'))
