...
class DLADS:
    ...
    def computeLoss(self, data, label, trainFlag=False, epoch=None, step=None):
        ...
        #loss = torch.mean(torch.abs(label-self.model(data)))
        loss = self.lossMethod(self.model(data), label)
    ...
    def train(self):
        ...
        for epoch in trainingBar:
            ...
            if cosineScheduler: self.scheduler.step()
