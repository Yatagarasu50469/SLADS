...
class Conv_DN_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        super().__init__()
        self.conv0 = Conv_SC_DLADS(numIn, numOut, 1, 'same', 'leaky_relu')
        self.pool0 = nn.MaxPool2d(kernel_size=2, stride=2)
        self.conv1 = Conv_PC_DLADS(numOut, numOut, 'leaky_relu')
...
class Conv_UP_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.conv1 = Conv_SC_DLADS(numOut, numOut, 2, 'same', 'relu')
