...
class Conv_IN_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.conv0 = Conv_PC_DLADS(numIn, numOut, 'prelu')
...
class Conv_UP_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.conv0 = Conv_SC_DLADS(numIn, numOut, 2, 'same', 'prelu')
        self.conv1 = Conv_PC_DLADS(numIn*2, numOut, 'prelu')
...
class Model_DLADS(nn.Module):
    def __init__(self, numFilt, numChan):
        ...
        self.convFn0 = Conv_SC_DLADS(numFilt, 1, 1, 'same', 'prelu')
