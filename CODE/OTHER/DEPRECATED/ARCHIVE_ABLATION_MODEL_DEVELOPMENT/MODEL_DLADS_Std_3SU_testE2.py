...
class Conv_PC_DLADS(nn.Module):
    def __init__(self, numIn, numOut, act):
        ...
        self.conv0 = Conv_DR_DLADS(numIn, numOut, act)
        self.conv1 = nn.Conv2d(in_channels=numOut, out_channels=numOut, kernel_size=3, stride=1, padding='same', bias=useBias)
        self.conv2 = nn.Conv2d(in_channels=numOut, out_channels=numOut, kernel_size=3, stride=1, padding='same', bias=useBias)
    ...
    def forward(self, data):
        ...
        return self.act(self.conv2(data))
