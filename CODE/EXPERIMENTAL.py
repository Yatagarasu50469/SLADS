...
def performImplementation(bestC, bestModel):
    ...
    #Run SLADS
    result = runSLADS(info, impSample, bestModel, scanMethod, stopPerc, 0, simulationFlag=False, trainPlotFlag=False, animationFlag=animationGen, tqdmHide=False, bestCFlag=False)
