...
class Conv_Up_DLADS(nn.Module):
    def __init__(self, numIn, numOut):
        ...
        self.convUp1 = nn.Conv2d(in_channels=numIn+numOut, out_channels=numOut, kernel_size=1, stride=1, padding='same', bias=True)
        self.convUp2 = nn.Conv2d(in_channels=numOut, out_channels=numOut, kernel_size=3, stride=1, padding='same', bias=True)
