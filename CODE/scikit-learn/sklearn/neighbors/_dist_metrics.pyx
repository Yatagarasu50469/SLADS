...
# Modified by David Helminiak (2020)
# for use of a custom distance metric for SLADS
# Supervised Learning Algorithm for Dynamic Sampling
...
#------------------------------------------------------------
# Asymmetric distance for SLADS
# Simple euclidean for data with mandated, but inaccurate asymmetry
cdef class asymDistance(DistanceMetric):
