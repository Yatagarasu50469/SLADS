...
static void __pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_num_col_to_bins(__Pyx_memviewslice, __Pyx_memviewslice, unsigned char const , __Pyx_memviewslice); /*proto*/
...
static PyObject *__pyx_pf_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_binning_thresholds, unsigned char __pyx_v_missing_values_bin_idx, __Pyx_memviewslice __pyx_v_binned); /* proto */
...
/* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":22
 * 
 * 
...
static char __pyx_doc_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins[] = "Bin numerical values to discrete integer-coded levels.\n\n    Parameters\n    ----------\n    data : ndarray, shape (n_samples, n_features)\n        The numerical data to bin.\n    binning_thresholds : list of arrays\n        For each feature, stores the increasing numeric values that are\n        used to separate the bins.\n    binned : ndarray, shape (n_samples, n_features)\n        Output array, must be fortran aligned.\n    ";
...
static PyObject *__pyx_pw_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_1_map_to_bins(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_data,&__pyx_n_s_binning_thresholds,&__pyx_n_s_missing_values_bin_idx,&__pyx_n_s_binned,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_binning_thresholds)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 4, 4, 1); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_missing_values_bin_idx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 4, 4, 2); __PYX_ERR(0, 22, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_binned)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 4, 4, 3); __PYX_ERR(0, 22, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_map_to_bins") < 0)) __PYX_ERR(0, 22, __pyx_L3_error)
      }
    ...
    __pyx_v_data = __Pyx_PyObject_to_MemoryviewSlice_dsds_nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C__const__(values[0], 0); if (unlikely(!__pyx_v_data.memview)) __PYX_ERR(0, 22, __pyx_L3_error)
    __pyx_v_binning_thresholds = ((PyObject*)values[1]);
    __pyx_v_missing_values_bin_idx = __Pyx_PyInt_As_unsigned_char(values[2]); if (unlikely((__pyx_v_missing_values_bin_idx == (unsigned char)-1) && PyErr_Occurred())) __PYX_ERR(0, 24, __pyx_L3_error)
    __pyx_v_binned = __Pyx_PyObject_to_MemoryviewSlice_dcd__nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_BINNED_DTYPE_C(values[3], PyBUF_WRITABLE); if (unlikely(!__pyx_v_binned.memview)) __PYX_ERR(0, 25, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_map_to_bins", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 22, __pyx_L3_error)
  __pyx_L3_error:;
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_binning_thresholds), (&PyList_Type), 1, "binning_thresholds", 1))) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_r = __pyx_pf_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins(__pyx_self, __pyx_v_data, __pyx_v_binning_thresholds, __pyx_v_missing_values_bin_idx, __pyx_v_binned);
...
static PyObject *__pyx_pf_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_to_bins(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_data, PyObject *__pyx_v_binning_thresholds, unsigned char __pyx_v_missing_values_bin_idx, __Pyx_memviewslice __pyx_v_binned) {
  ...
  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":41
 *         int feature_idx
 * 
...
if (unlikely(__pyx_v_binning_thresholds == Py_None)) {
      ...
      /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":43
 *     for feature_idx in range(data.shape[1]):
 *         _map_num_col_to_bins(data[:, feature_idx],
 *                              binning_thresholds[feature_idx],             # <<<<<<<<<<<<<<
 *                              missing_values_bin_idx,
 ...
 */
    ...
    __pyx_t_5 = __Pyx_PyObject_to_MemoryviewSlice_ds_nn___pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_DTYPE_C__const__(PyList_GET_ITEM(__pyx_v_binning_thresholds, __pyx_v_feature_idx), 0); if (unlikely(!__pyx_t_5.memview)) __PYX_ERR(0, 43, __pyx_L1_error)

    /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":45
 *                              binning_thresholds[feature_idx],
 *                              missing_values_bin_idx,
 *                              binned[:, feature_idx])             # <<<<<<<<<<<<<<
 * 
...
__pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_num_col_to_bins(__pyx_t_4, __pyx_t_5, __pyx_v_missing_values_bin_idx, __pyx_t_6);
...
/* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":48
 * 
 * 
...
static void __pyx_f_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning__map_num_col_to_bins(__Pyx_memviewslice __pyx_v_data, __Pyx_memviewslice __pyx_v_binning_thresholds, unsigned char const __pyx_v_missing_values_bin_idx, __Pyx_memviewslice __pyx_v_binned) {
  int __pyx_v_i;
  int __pyx_v_left;
  int __pyx_v_right;
  int __pyx_v_middle;
  ...
  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":59
 *         int middle
 * 
 ...
 */
  {
      ...
      #endif
      /*try:*/ {
        if (unlikely(!__pyx_v_data.memview)) { __Pyx_RaiseUnboundMemoryviewSliceNogil("data"); __PYX_ERR(0, 59, __pyx_L4_error) }
 ...
 */
                            ...
                            if (__pyx_t_5) {
                              ...
                              /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":62
 * 
 *         if isnan(data[i]):
 *             binned[i] = missing_values_bin_idx             # <<<<<<<<<<<<<<
 *         else:
 ...
 */
                            /*else*/ {
                              ...
                              /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":66
 *             # for known values, use binary search
 *             left, right = 0, binning_thresholds.shape[0]
 *             while left < right:             # <<<<<<<<<<<<<<
 *                 middle = (right + left - 1) // 2
 ...
 */
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":68
 *             while left < right:
 *                 middle = (right + left - 1) // 2
 *                 if data[i] <= binning_thresholds[middle]:             # <<<<<<<<<<<<<<
 *                     right = middle
 ...
 */
                                ...
                                /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":71
 *                     right = middle
 *                 else:
 *                     left = middle + 1             # <<<<<<<<<<<<<<
 *             binned[i] = left
 */
                              ...
                              /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":72
 *                 else:
 *                     left = middle + 1
 *             binned[i] = left             # <<<<<<<<<<<<<<
 */
                              __pyx_t_9 = __pyx_v_i;
                              *((__pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_X_BINNED_DTYPE_C *) ( /* dim=0 */ (__pyx_v_binned.data + __pyx_t_9 * __pyx_v_binned.strides[0]) )) = __pyx_v_left;
                            }
                            __pyx_L10:;
                        }
                    }
 ...
 */
  ...
  goto __pyx_L0;
  __pyx_L1_error:;
  __Pyx_WriteUnraisable("sklearn.ensemble._hist_gradient_boosting._binning._map_num_col_to_bins", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
}
 ...
 *                  const unsigned char missing_values_bin_idx,
 */
  __pyx_tuple__26 = PyTuple_Pack(5, __pyx_n_s_data, __pyx_n_s_binning_thresholds, __pyx_n_s_missing_values_bin_idx, __pyx_n_s_binned, __pyx_n_s_feature_idx); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(4, 0, 5, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_map_to_bins, 22, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 22, __pyx_L1_error)
...
if (!__Pyx_RefNanny) {
  ...
  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":11
 * cimport cython
 * 
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "sklearn/ensemble/_hist_gradient_boosting/_binning.pyx":19
 ...
 *                  const unsigned char missing_values_bin_idx,
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_7sklearn_8ensemble_23_hist_gradient_boosting_8_binning_1_map_to_bins, NULL, __pyx_n_s_sklearn_ensemble__hist_gradient_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_map_to_bins, __pyx_t_1) < 0) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
